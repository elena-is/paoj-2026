...
public class Student {
    ...
    public Student(String name, int age) {
        ...
        if (age < 18 || age > 60) {
            throw new InvalidStudentException("Varsta " + age + " este invalida pentru un student (18-60).");
        }
        this.name = name;
        this.age = age;
    ...
    public void addGrade(Subject subject, double grade) {
        if (grade < 1 || grade > 10) {
            throw new InvalidGradeException("Nota " + grade + " este invalida (trebuie sa fie intre 1 si 10).");
        }
